# Задача № 38(от 40). Дополнить справочник возможностью копирования данных из одного файла в другой. 
...
def write_file(file_name, lst):
    ...
    res.append(obj)
    with open(file_name, 'w', encoding = 'utf-8', newline = '') as data:  #перезаписываем наш файл; newline = '' - не будет лишних строк
        f_writer = DictWriter(data, fieldnames = ['Имя', 'Фамилия', 'Телефон'])
        f_writer.writeheader()
